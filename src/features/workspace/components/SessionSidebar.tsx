										...
										{workspace.worktrees.map((worktree) => {
											...
											const rowContents = isRenamingThisRow ? (
												...
												<>
														...
														{isReady && (
															<span className="shell-sidebar__row-ready">
																...
																{readyInlineStatus && (
																	...
																	>
																		<span className="shell-sidebar__process shell-sidebar__process--session shell-sidebar__item-status">
													...
													{hasCustomTitle && (
														<SidebarTooltip label={worktree.label}>
															<div
																className="shell-sidebar__worktree-label"
																data-testid="sidebar-worktree-label"
															>
																{worktree.label}
															</div>
														</SidebarTooltip>
													...
													{worktree.branchName !== worktree.label && (
														<SidebarTooltip label={worktree.branchName}>
															<div
																...
																<>
																	{visibleRows.map((row) => (
																		...
																		>
																			...
																			<SidebarTooltip label={row.label}>
																				<span className="shell-sidebar__process-label">
																					{row.label}
																				</span>
																			</SidebarTooltip>
																			{row.context ? (
																				<SidebarTooltip label={row.context}>
																					<span className="shell-sidebar__process-context">
																						{row.context}
																					</span>
																				</SidebarTooltip>
										...
										{workspace.active && (
											<div className="shell-sidebar__node shell-sidebar__node--new">
												<Button
													...
													onClick={() =>
														onCreateWorktree(workspace.workspaceId)
													}
