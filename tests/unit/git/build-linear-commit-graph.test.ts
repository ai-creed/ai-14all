	...
	it("marks the merge-target row and preserves commit order", () => {
		expect(
			buildLinearCommitGraph([
				{ sha: "c1", shortSha: "c1", subject: "feature 1", isMergeTarget: false },
				{ sha: "c2", shortSha: "c2", subject: "feature 2", isMergeTarget: false },
				{ sha: "b0", shortSha: "b0", subject: "origin/main", isMergeTarget: true },
			]),
		).toEqual([
